...
int trap1_dispatch(void) {
    ...
    switch (syscall_no) {
        case SYSCALL_OPEN:
            ret = stuber_open_r(r, (const char *)arg1, arg2, arg3);
            break;
        case SYSCALL_CLOSE:
            ret = stuber_close_r(r, arg1);
            break;
        case SYSCALL_READ:
            ret = stuber_read_r(r, arg1, (void *)arg2, arg3);
            break;
        case SYSCALL_WRITE:
            ret = stuber_write_r(r, arg1, (const void *)arg2, arg3);
            break;
        case SYSCALL_LSEEK:
            ret = stuber_lseek_r(r, arg1, arg2, arg3);
            break;
        case SYSCALL_FSTAT:
            ret = stuber_fstat_r(r, arg1, (void *)arg2);
            break;
        case SYSCALL_ISTTY:
            ret = stuber_isatty_r(r, arg1);
            break;
        case SYSCALL_STAT:
            ret = stuber_stat_r(r, (const char *)arg1, (void *)arg2);
            break;
        case SYSCALL_TIME:
            ret = stuber_gettimeofday_r(r, (void *)arg1, (void*)arg2);
            break;
        case SYSCALL_CWD:
        ...
        case SYSCALL_RMDIR:
            ...
            break;
        case SYSCALL_UNLINK:
            ret = stuber_unlink_r(r, (const char*)arg1);
            break;
        case SYSCALL_GETPID:
            r->_errno = 0;
            ret = cur_pid;
