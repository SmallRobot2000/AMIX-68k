...
int trap1_dispatch(void) {
    ...
    switch (syscall_no) {
        case SYSCALL_OPEN:
            ret = _stub_open_r(r, (const char *)arg1, arg2, arg3);
            break;
        case SYSCALL_CLOSE:
            ret = _stub_close_r(r, arg1);
            break;
        case SYSCALL_READ:
            ret = _stub_read_r(r, arg1, (void *)arg2, arg3);
            break;
        case SYSCALL_WRITE:
            ret = _stub_write_r(r, arg1, (const void *)arg2, arg3);
            break;
        case SYSCALL_LSEEK:
            ret = _stub_lseek_r(r, arg1, arg2, arg3);
            break;
        case SYSCALL_FSTAT:
            ret = _stub_fstat_r(r, arg1, (void *)arg2);
            break;
        case SYSCALL_ISTTY:
            ret = _stub_isatty_r(r, arg1);
            break;
        case SYSCALL_STAT:
            ret = _stub_stat_r(r, (const char *)arg1, (void *)arg2);
            break;
        case SYSCALL_TIME:
            ret = _stub_gettimeofday_r(r, (void *)arg1, (void*)arg2);
            break;
        case SYSCALL_CWD:
        ...
        case SYSCALL_RMDIR:
            ...
            break;
        case SYSCALL_UNLINK:
            ret = _stub_unlink_r(r, (const char*)arg1);
            break;
        case SYSCALL_GETPID:
            r->_errno = 0;
            ret = cur_pid;
